...
import { Problem, InputSum as Sum, InputCell as Cell } from '../src/problem.js';

describe('Reader tests', () => {
    test('Basic read', () => {
        const problem = reader('./test/readerBaseTest.txt');
        expect(problem).toEqual(new Problem([
            new Sum(17, [ new Cell(1, 1), new Cell(1, 2), new Cell(1, 3) ]),
            new Sum(7, [ new Cell(1, 4) ]),
            new Sum(9, [ new Cell(1, 5), new Cell(1, 6) ]),
        ]));
    });
    ...
    test('Full read - real problem #2', () => {
        ...
        expect(problem).toEqual(new Problem([
            ...
            new Sum(14, [ new Cell(5, 3), new Cell(6, 3), new Cell(6, 4) ]),
