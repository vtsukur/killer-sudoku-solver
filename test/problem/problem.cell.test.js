    ...
    test('NonetSolver index for cells', () => {
        ...
        _.range(0, 3).forEach(r => {
            _.range(0, 3).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(0);
            })
        })
        ...
        _.range(0, 3).forEach(r => {
            _.range(3, 6).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(1);
            })
        })
        ...
        _.range(0, 3).forEach(r => {
            _.range(6, 9).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(2);
            })
        })
        ...
        _.range(3, 6).forEach(r => {
            _.range(0, 3).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(3);
            })
        })
        ...
        _.range(3, 6).forEach(r => {
            _.range(3, 6).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(4);
            })
        })
        ...
        _.range(3, 6).forEach(r => {
            _.range(6, 9).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(5);
            })
        })
        ...
        _.range(6, 9).forEach(r => {
            _.range(0, 3).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(6);
            })
        })
        ...
        _.range(6, 9).forEach(r => {
            _.range(3, 6).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(7);
            })
        })
        ...
        _.range(6, 9).forEach(r => {
            _.range(6, 9).forEach(c => {
                expect(Cell.at(r, c).nonetIdx).toBe(8);
            })
        })
    });
