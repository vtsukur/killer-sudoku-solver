...
export const sudokuDotCom_dailyChallengeOf_2022_04_06 = new Problem([
    ...
    Cage.of(17).cell(0, 3).cell(1, 3).cell(1, 4).mk(),
    Cage.of(7).cell(2, 3).cell(2, 4).mk(),
    Cage.of(16).cell(0, 4).cell(0, 5).cell(0, 6).mk(),
    Cage.of(6).cell(1, 5).mk(),
    Cage.of(18).cell(2, 5).cell(3, 3).cell(3, 4).cell(3, 5).mk(),
    Cage.of(11).cell(0, 7).cell(0, 8).cell(1, 8).mk(),
    Cage.of(12).cell(1, 6).cell(1, 7).mk(),
    ...
    Cage.of(18).cell(5, 2).cell(6, 2).cell(6, 3).cell(6, 4).mk(),
    Cage.of(8).cell(4, 3).cell(5, 3).mk(),
    Cage.of(13).cell(4, 4).cell(5, 4).mk(),
    Cage.of(12).cell(4, 5).cell(4, 6).mk(),
    Cage.of(12).cell(5, 5).cell(6, 5).mk(),
    Cage.of(10).cell(4, 7).cell(4, 8).mk(),
    ...
    Cage.of(11).cell(7, 2).cell(8, 2).mk(),
    Cage.of(7).cell(7, 3).cell(7, 4).mk(),
    Cage.of(20).cell(8, 3).cell(8, 4).cell(8, 5).mk(),
    Cage.of(15).cell(7, 5).cell(7, 6).cell(7, 7).mk(),
    Cage.of(11).cell(6, 6).cell(6, 7).mk(),
    Cage.of(3).cell(8, 6).cell(8, 7).mk(),
    Cage.of(12).cell(7, 8).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_08_12 = new Problem([
    ...
    Cage.of(11).cell(0, 2).cell(0, 3).mk(),
    Cage.of(10).cell(1, 2).cell(1, 3).mk(),
    Cage.of(18).cell(2, 1).cell(2, 2).cell(2, 3).mk(),
    Cage.of(17).cell(0, 4).cell(0, 5).cell(0, 6).mk(),
    Cage.of(7).cell(1, 4).cell(1, 5).mk(),
    Cage.of(14).cell(2, 4).cell(3, 4).mk(),
    Cage.of(5).cell(2, 5).cell(2, 6).mk(),
    Cage.of(13).cell(0, 7).cell(0, 8).mk(),
    ...
    Cage.of(21).cell(5, 1).cell(5, 2).cell(5, 3).cell(6, 2).mk(),
    Cage.of(10).cell(3, 3).cell(4, 3).mk(),
    Cage.of(8).cell(4, 4).cell(5, 4).mk(),
    Cage.of(20).cell(3, 5).cell(3, 6).cell(3, 7).cell(3, 8).mk(),
    Cage.of(11).cell(4, 5).cell(4, 6).mk(),
    Cage.of(14).cell(5, 5).cell(6, 5).mk(),
    ...
    Cage.of(8).cell(8, 3).cell(8, 4).mk(),
    Cage.of(17).cell(7, 4).cell(7, 5).cell(7, 6).mk(),
    Cage.of(15).cell(8, 5).cell(8, 6).cell(8, 7).mk(),
    Cage.of(4).cell(6, 6).mk(),
    Cage.of(12).cell(6, 7).cell(7, 7).mk(),
    Cage.of(7).cell(7, 8).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_08_30 = new Problem([
    ...
    Cage.of(13).cell(2, 2).cell(2, 3).mk(),
    Cage.of(22).cell(0, 3).cell(0, 4).cell(1, 3).mk(),
    Cage.of(14).cell(0, 5).cell(0, 6).cell(0, 7).mk(),
    Cage.of(15).cell(1, 4).cell(2, 4).cell(3, 4).mk(),
    Cage.of(17).cell(1, 5).cell(2, 5).cell(3, 5).mk(),
    Cage.of(14).cell(1, 6).cell(1, 7).cell(2, 6).mk(),
    ...
    Cage.of(15).cell(5, 2).cell(6, 2).mk(),
    Cage.of(5).cell(3, 3).mk(),
    Cage.of(17).cell(4, 3).cell(4, 4).cell(4, 5).mk(),
    Cage.of(9).cell(5, 3).cell(6, 3).mk(),
    Cage.of(12).cell(5, 4).cell(6, 4).mk(),
    Cage.of(7).cell(5, 5).cell(6, 5).mk(),
    Cage.of(18).cell(3, 6).cell(4, 6).cell(4, 7).mk(),
    Cage.of(15).cell(5, 6).cell(6, 6).cell(7, 6).mk(),
    ...
    Cage.of(7).cell(7, 4).cell(7, 5).mk(),
    Cage.of(3).cell(8, 3).cell(8, 4).mk(),
    Cage.of(13).cell(8, 5).cell(8, 6).mk(),
    Cage.of(18).cell(6, 7).cell(7, 7).cell(8, 7).mk(),
    Cage.of(12).cell(7, 8).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_10_18 = new Problem([
    ...
    Cage.of(13).cell(0, 2).cell(0, 3).cell(1, 2).mk(),
    Cage.of(4).cell(1, 3).mk(),
    Cage.of(9).cell(0, 4).cell(1, 4).mk(),
    Cage.of(17).cell(0, 5).cell(1, 5).mk(),
    Cage.of(14).cell(2, 4).cell(3, 4).mk(),
    Cage.of(5).cell(2, 5).cell(3, 5).mk(),
    Cage.of(4).cell(0, 6).mk(),
    Cage.of(9).cell(0, 7).cell(0, 8).cell(1, 8).mk(),
    Cage.of(13).cell(1, 6).cell(1, 7).mk(),
    ...
    Cage.of(14).cell(3, 2).cell(3, 3).mk(),
    Cage.of(8).cell(5, 2).cell(5, 3).mk(),
    Cage.of(6).cell(4, 4).cell(5, 4).mk(),
    Cage.of(10).cell(4, 5).cell(5, 5).mk(),
    Cage.of(16).cell(4, 7).cell(4, 8).cell(5, 7).mk(),
    ...
    Cage.of(9).cell(7, 2).cell(8, 2).mk(),
    Cage.of(13).cell(6, 3).cell(6, 4).cell(6, 5).mk(),
    Cage.of(8).cell(7, 3).cell(8, 3).mk(),
    Cage.of(18).cell(7, 4).cell(7, 5).cell(8, 4).mk(),
    Cage.of(5).cell(6, 7).mk(),
    Cage.of(15).cell(7, 7).cell(7, 8).mk(),
    Cage.of(20).cell(8, 5).cell(8, 6).cell(8, 7).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_10_19 = new Problem([
    ...
    Cage.of(14).cell(0, 2).cell(0, 3).mk(),
    Cage.of(10).cell(1, 2).cell(1, 3).cell(1, 4).mk(),
    Cage.of(18).cell(0, 4).cell(0, 5).cell(1, 5).mk(),
    Cage.of(11).cell(2, 3).cell(2, 4).mk(),
    Cage.of(8).cell(2, 5).cell(3, 5).mk(),
    Cage.of(10).cell(2, 6).cell(3, 6).mk(),
    Cage.of(13).cell(0, 6).cell(1, 6).mk(),
    Cage.of(5).cell(0, 7).cell(1, 7).mk(),
    ...
    Cage.of(16).cell(5, 2).cell(6, 2).mk(),
    Cage.of(6).cell(3, 3).cell(3, 4).mk(),
    Cage.of(15).cell(4, 4).cell(4, 5).mk(),
    Cage.of(12).cell(5, 4).cell(5, 5).mk(),
    Cage.of(15).cell(3, 7).cell(3, 8).mk(),
    Cage.of(9).cell(4, 6).cell(5, 6).mk(),
    Cage.of(9).cell(4, 7).cell(4, 8).mk(),
    ...
    Cage.of(17).cell(6, 3).cell(7, 3).cell(7, 4).mk(),
    Cage.of(15).cell(6, 4).cell(6, 5).cell(6, 6).mk(),
    Cage.of(19).cell(7, 5).cell(7, 6).cell(7, 7).cell(8, 7).mk(),
    Cage.of(13).cell(8, 4).cell(8, 5).cell(8, 6).mk(),
    Cage.of(9).cell(7, 8).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_10_22 = new Problem([
    ...
    Cage.of(19).cell(0, 2).cell(0, 3).cell(0, 4).cell(1, 2).mk(),
    Cage.of(22).cell(2, 2).cell(3, 2).cell(3, 3).mk(),
    Cage.of(10).cell(1, 3).cell(2, 3).mk(),
    Cage.of(14).cell(1, 4).cell(2, 4).mk(),
    Cage.of(14).cell(0, 5).cell(0, 6).cell(1, 5).mk(),
    Cage.of(8).cell(2, 5).cell(2, 6).mk(),
    Cage.of(8).cell(0, 7).cell(1, 6).cell(1, 7).mk(),
    ...
    Cage.of(14).cell(5, 2).cell(6, 1).cell(6, 2).mk(),
    Cage.of(6).cell(4, 3).cell(5, 3).mk(),
    Cage.of(8).cell(3, 4).cell(3, 5).mk(),
    Cage.of(9).cell(4, 4).cell(4, 5).mk(),
    Cage.of(17).cell(5, 4).cell(6, 3).cell(6, 4).mk(),
    Cage.of(6).cell(5, 5).mk(),
    Cage.of(18).cell(3, 6).cell(3, 7).cell(4, 6).mk(),
    Cage.of(14).cell(4, 7).cell(5, 7).mk(),
    ...
    Cage.of(21).cell(7, 4).cell(7, 5).cell(7, 6).cell(8, 5).mk(),
    Cage.of(10).cell(8, 3).cell(8, 4).mk(),
    Cage.of(10).cell(6, 7).cell(7, 7).mk(),
    Cage.of(19).cell(6, 8).cell(7, 8).cell(8, 8).mk(),
    Cage.of(13).cell(8, 6).cell(8, 7).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_10_25 = new Problem([
    ...
    Cage.of(7).cell(2, 0).cell(3, 0).mk(),
    Cage.of(17).cell(2, 2).cell(2, 3).cell(2, 4).cell(2, 5).mk(),
    Cage.of(11).cell(0, 3).cell(0, 4).mk(),
    Cage.of(8).cell(1, 4).cell(1, 5).mk(),
    Cage.of(12).cell(0, 5).cell(0, 6).cell(0, 7).mk(),
    Cage.of(12).cell(0, 8).cell(1, 8).mk(),
    ...
    Cage.of(16).cell(3, 2).cell(3, 3).cell(3, 4).mk(),
    Cage.of(10).cell(4, 2).cell(4, 3).mk(),
    Cage.of(27).cell(3, 5).cell(4, 4).cell(4, 5).cell(5, 4).cell(5, 5).mk(),
    Cage.of(5).cell(5, 3).cell(6, 3).mk(),
    Cage.of(11).cell(3, 6).cell(3, 7).mk(),
    Cage.of(20).cell(4, 6).cell(4, 7).cell(5, 6).mk(),
    ...
    Cage.of(20).cell(7, 2).cell(7, 3).cell(8, 3).mk(),
    Cage.of(6).cell(6, 4).cell(7, 4).mk(),
    Cage.of(13).cell(6, 5).cell(6, 6).mk(),
    Cage.of(18).cell(7, 5).cell(8, 4).cell(8, 5).cell(8, 6).mk(),
    Cage.of(12).cell(7, 6).cell(7, 7).mk(),
    Cage.of(15).cell(7, 8).cell(8, 7).cell(8, 8).mk()
]);
...
export const sudokuDotCom_dailyChallengeOf_2022_11_10 = new Problem([
    ...
    Cage.of(11).cell(1, 1).cell(2, 1).mk(),
    Cage.of(16).cell(2, 2).cell(3, 2).mk(),
    Cage.of(11).cell(0, 3).cell(0, 4).mk(),
    Cage.of(9).cell(0, 5).cell(1, 5).mk(),
    Cage.of(22).cell(1, 3).cell(2, 3).cell(3, 3).mk(),
    Cage.of(7).cell(1, 4).cell(2, 4).mk(),
    Cage.of(15).cell(2, 5).cell(3, 4).cell(3, 5).mk(),
    Cage.of(20).cell(0, 6).cell(0, 7).cell(1, 6).mk(),
    Cage.of(15).cell(0, 8).cell(1, 8).cell(2, 8).cell(3, 8).mk(),
    ...
    Cage.of(11).cell(5, 1).cell(5, 2).mk(),
    Cage.of(4).cell(4, 3).cell(5, 3).mk(),
    Cage.of(13).cell(4, 4).cell(5, 4).mk(),
    Cage.of(8).cell(4, 5).cell(4, 6).mk(),
    ...
    Cage.of(12).cell(7, 3).cell(8, 2).cell(8, 3).mk(),
    Cage.of(11).cell(6, 4).cell(7, 4).mk(),
    Cage.of(10).cell(8, 4).cell(8, 5).mk(),
    Cage.of(17).cell(6, 6).cell(7, 5).cell(7, 6).cell(7, 7).mk(),
    Cage.of(8).cell(6, 7).cell(6, 8).mk(),
    Cage.of(17).cell(7, 8).cell(8, 8).mk(),
    Cage.of(8).cell(8, 6).cell(8, 7).mk()
]);
...
export const sudokuDotCom_randomExpertLevelChallenge = new Problem([
    ...
    Cage.of(3).cell(0, 4).mk(),
    Cage.of(20).cell(1, 3).cell(1, 4).cell(2, 4).mk(),
    Cage.of(15).cell(2, 3).cell(3, 3).mk(),
    Cage.of(6).cell(0, 5).cell(0, 6).mk(),
    Cage.of(18).cell(1, 5).cell(1, 6).cell(2, 5).cell(2, 6).mk(),
    Cage.of(16).cell(0, 7).cell(0, 8).mk(),
    ...
    Cage.of(21).cell(5, 1).cell(6, 1).cell(6, 2).mk(),
    Cage.of(23).cell(3, 4).cell(4, 3).cell(4, 4).cell(4, 5).mk(),
    Cage.of(7).cell(5, 3).cell(5, 4).mk(),
    Cage.of(4).cell(3, 5).cell(3, 6).mk(),
    Cage.of(21).cell(5, 5).cell(5, 6).cell(6, 5).mk(),
    Cage.of(9).cell(3, 7).cell(3, 8).mk(),
    ...
    Cage.of(21).cell(8, 2).cell(8, 3).cell(8, 4).mk(),
    Cage.of(13).cell(6, 3).cell(7, 3).mk(),
    Cage.of(3).cell(6, 4).cell(7, 4).mk(),
    Cage.of(11).cell(7, 5).cell(7, 6).mk(),
    Cage.of(5).cell(8, 5).cell(8, 6).mk(),
    Cage.of(10).cell(6, 6).cell(6, 7).mk(),
    Cage.of(13).cell(7, 7).cell(8, 7).mk(),
    Cage.of(11).cell(7, 8).cell(8, 8).mk()
]);
