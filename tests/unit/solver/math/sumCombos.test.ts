...
describe('Tests for `SumCombos`', () => {
    [
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 2 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 3 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 4 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 5 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 6 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 7 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 8 unique numbers`, () => {
        ...
        test(`[${combosFnVal.name}] Number combinations to form a sum out of 9 unique numbers`, () => {
