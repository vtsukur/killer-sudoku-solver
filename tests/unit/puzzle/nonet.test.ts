    ...
    test('Determination of Nonet index by Cell', () => {
        ...
        _.range(0, 3).forEach((row: number) => {
            _.range(0, 3).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(0);
            });
        });
        ...
        _.range(0, 3).forEach((row: number) => {
            _.range(3, 6).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(1);
            });
        });
        ...
        _.range(0, 3).forEach((row: number) => {
            _.range(6, 9).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(2);
            });
        });
        ...
        _.range(3, 6).forEach((row: number) => {
            _.range(0, 3).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(3);
            });
        });
        ...
        _.range(3, 6).forEach((row: number) => {
            _.range(3, 6).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(4);
            });
        });
        ...
        _.range(3, 6).forEach((row: number) => {
            _.range(6, 9).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(5);
            });
        });
        ...
        _.range(6, 9).forEach((row: number) => {
            _.range(0, 3).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(6);
            });
        });
        ...
        _.range(6, 9).forEach((row: number) => {
            _.range(3, 6).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(7);
            });
        });
        ...
        _.range(6, 9).forEach((row: number) => {
            _.range(6, 9).forEach((col: number) => {
                expect(Nonet.forCellAt(row, col)).toBe(8);
            });
        });
    });
