...
describe('Unit tests for `FindAndSliceComplementsForGridAreasStrategy`', () => {
    ...
    test('Applying strategy for single `Column`s onto Daily Challenge (2022-10-22) by Sudoku.com', () => {
        ...
        expect(context.model.cageModelsMap.size).toBe(originalCageCount + House.COUNT_OF_ONE_TYPE_PER_GRID);
        // (`Column` 0)
        expect(context.model.hasCage(Cage.ofSum(37).at(0, 0).at(1, 0).at(2, 0).at(3, 0).at(4, 0).at(5, 0).at(6, 0).new()));
        // (`Column` 1)
        expect(context.model.hasCage(Cage.ofSum(45).at(0, 1).at(1, 1).at(2, 1).at(3, 1).at(4, 1).at(5, 1).at(6, 1).at(7, 1).at(8, 1).new()));
        // (`Column` 2)
        expect(context.model.hasCage(Cage.ofSum(45).at(0, 2).at(1, 2).at(2, 2).at(3, 2).at(4, 2).at(5, 2).at(6, 2).at(7, 2).at(8, 2).new()));
        // (`Column` 3)
        expect(context.model.hasCage(Cage.ofSum(29).at(0, 3).at(3, 3).at(6, 3).at(7, 3).at(8, 3).new()));
        // (`Column` 4)
        expect(context.model.hasCage(Cage.ofSum(31).at(0, 4).at(3, 4).at(4, 4).at(5, 4).at(6, 4).at(7, 4).at(8, 4).new()));
        // (`Column` 5)
        expect(context.model.hasCage(Cage.ofSum(39).at(0, 5).at(1, 5).at(2, 5).at(3, 5).at(4, 5).at(6, 5).at(7, 5).at(8, 5).new()));
        // (`Column` 6)
        expect(context.model.hasCage(Cage.ofSum(45).at(0, 6).at(1, 6).at(2, 6).at(3, 6).at(4, 6).at(5, 6).at(6, 6).at(7, 6).at(8, 6).new()));
        // (`Column` 7)
        expect(context.model.hasCage(Cage.ofSum(31).at(0, 7).at(1, 7).at(2, 7).at(3, 7).at(8, 7).new()));
        // (`Column` 8)
