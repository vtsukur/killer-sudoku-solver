...
describe('Tests for master model', () => {
    test('Construction of master model (shallow coverage)', () => {
        ...
        expect(solver.nonetModels.length).toBe(House.SIZE);
        expect(solver.nonetModels[1].cages[2]).toEqual(Cage.ofSum(11).at(2, 3).at(2, 4).mk());
        ...
        expect(aCellModelerminator.nonetModel.idx).toEqual(1);
